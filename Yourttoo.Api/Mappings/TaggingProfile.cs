    ...
    public class TaggingProfile : Profile
    {
        public TaggingProfile() 
        {
            CreateMap<TagCategory, TagCategoryDTO>()
                .ForMember(dest => dest.Name, opt => opt.MapFrom(src => src.Name.FirstOrDefault() ?? new IdiomaticText()))
                .ForMember(dest => dest.Description, opt => opt.MapFrom(src => src.Description.FirstOrDefault() ?? new IdiomaticText()))
            ...
            CreateMap<TagCategoryDTO, TagCategory>()
                .ForMember(dest => dest.Name, opt => opt.MapFrom(src => new List<IdiomaticText> { src.Name }))
                .ForMember(dest => dest.Description, opt => opt.MapFrom(src => new List<IdiomaticText> { src.Description }))
            ...
            CreateMap<Tag, TagDTO>()
                .ForMember(dest => dest.Name, opt => opt.MapFrom(src => src.Name.FirstOrDefault() ?? new IdiomaticText()))
                .ForMember(dest => dest.Description, opt => opt.MapFrom(src => src.Description.FirstOrDefault() ?? new IdiomaticText()))
                .ForMember(dest => dest.Label, opt => opt.MapFrom(src => src.Label.FirstOrDefault() ?? new IdiomaticText()))
            ...
            CreateMap<TagDTO, Tag>()
                .ForMember(dest => dest.Name, opt => opt.MapFrom(src => new List<IdiomaticText> { src.Name }))
                .ForMember(dest => dest.Description, opt => opt.MapFrom(src => new List<IdiomaticText> { src.Description }))
                .ForMember(dest => dest.Label, opt => opt.MapFrom(src => new List<IdiomaticText> { src.Label }))
